    ...
    (() => {
        ...
        function menuInit() {
            if (document.querySelector(".icon-menu")) document.addEventListener("click", (function(e) {
                ...
                } else document.addEventListener("click", menuClose(), false);
            }));
        }
        function menuClose() {
            bodyUnlock();
        ...
        window.addEventListener("DOMContentLoaded", (() => {
            ...
            serviceButtons.forEach((serviceButton => {
                serviceButton.addEventListener("click", (event => {
                    ...
                    if (isLimitActiveBtns() && !serviceButton.classList.contains("active-btn")) serviceButton.classList.add("active-btn"); else if (serviceButton.classList.contains("active-btn")) serviceButton.classList.remove("active-btn");
            ...
            const filter = filterState => {
                ...
                if (filterState.length) serviceItems.classList.add("filtered"); else serviceItems.classList.remove("filtered");
